class Api::V1::ExecutionsController < ApplicationController
  ...
  def show
    ...
    @player = movie.players.find_or_create_by(end_date: nil, user: curernt_user)
    render json: Api::V1::PlayerSerializer.new(@player, include: params[:movie]).serialized_json
  end
